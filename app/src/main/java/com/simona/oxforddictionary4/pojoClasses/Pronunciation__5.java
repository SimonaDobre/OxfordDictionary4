...
public class Pronunciation__5 {
    ...
    @Expose
    private List<Region__16> regions = null;
    @SerializedName("registers")
    @Expose
    private List<Register__16> registers = null;
    ...
    public List<Region__16> getRegions() {
        return regions;
    }

    public void setRegions(List<Region__16> regions) {
        this.regions = regions;
    }

    public List<Register__16> getRegisters() {
        return registers;
    }

    public void setRegisters(List<Register__16> registers) {
