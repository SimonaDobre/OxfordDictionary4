...
public class Pronunciation__8 {
    ...
    @Expose
    private List<Region__23> regions = null;
    @SerializedName("registers")
    @Expose
    private List<Register__23> registers = null;
    ...
    public List<Region__23> getRegions() {
        return regions;
    }

    public void setRegions(List<Region__23> regions) {
        this.regions = regions;
    }

    public List<Register__23> getRegisters() {
        return registers;
    }

    public void setRegisters(List<Register__23> registers) {
