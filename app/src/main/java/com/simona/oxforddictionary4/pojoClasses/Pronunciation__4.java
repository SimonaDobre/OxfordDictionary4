...
public class Pronunciation__4 {
    ...
    @Expose
    private List<Region__14> regions = null;
    @SerializedName("registers")
    @Expose
    private List<Register__14> registers = null;
    ...
    public List<Region__14> getRegions() {
        return regions;
    }

    public void setRegions(List<Region__14> regions) {
        this.regions = regions;
    }

    public List<Register__14> getRegisters() {
        return registers;
    }

    public void setRegisters(List<Register__14> registers) {
