...
public class Pronunciation__3 {
    ...
    @Expose
    private List<Region__11> regions = null;
    @SerializedName("registers")
    @Expose
    private List<Register__11> registers = null;
    ...
    public List<Region__11> getRegions() {
        return regions;
    }

    public void setRegions(List<Region__11> regions) {
        this.regions = regions;
    }

    public List<Register__11> getRegisters() {
        return registers;
    }

    public void setRegisters(List<Register__11> registers) {
